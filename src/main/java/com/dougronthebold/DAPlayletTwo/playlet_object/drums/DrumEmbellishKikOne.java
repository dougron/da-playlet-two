...
public class DrumEmbellishKikOne extends PlayletObject implements PlayletObjectInterface, Processor{

	private PlugInDrumEmbellish plug = new PlugInDrumEmbellish(DrumStaticVariables.kikNote);
	
	private static final int min = 10;
	private static final int stepSize = 2;
	
	public DrumEmbellishKikOne(double x, double y, String uniqueName, PlobjParent pp){
