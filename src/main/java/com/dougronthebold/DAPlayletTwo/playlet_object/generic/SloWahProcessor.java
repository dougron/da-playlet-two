...
public class SloWahProcessor extends PlayletObject implements PlayletObjectInterface{
	...
	public SloWahProcessor(double x, double y, String uniqueName, PlobjParent pp){
